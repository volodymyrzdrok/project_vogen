...
1. - працювати в узгоджених брейкпойнтах та контейнерах
   - запис BEM класа таким стилем [block__element--modifier]
   - валідований html (https://validator.w3.org/#validate_by_input)

- використовувати var(--) змінні ,для спрощеного вкінці переходу на scss

2. - для роботи з svg іконками використовувати загальний sprite ,ось фото їх
     назви # (http://joxi.net/L21ab7VTg4vpz2)

3. - відступи між секціями не робимо ,працюємо кожен в своїй секції і надаємо
     **внутрішні падінги!** приклад (http://joxi.net/eAOK1ZvipYdzQA)

- відповідно крайнім елементам **забираємо марджини!** ,щоб потім не було
  випадаючих марджінів [схлопування] приклад (http://joxi.net/GrqwgQ5TkawW32)
